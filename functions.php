...
function frutiger_aero_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'frutiger-aero' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'frutiger-aero' ),
...
function frutiger_aero_scripts() {
	wp_enqueue_style( 'frutiger-aero-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'frutiger-aero-style', 'rtl', 'replace' );

	wp_enqueue_script( 'frutiger-aero-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
